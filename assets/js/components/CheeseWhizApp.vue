    ...
    <div class="wrapper">
        <div style="position:relative;">
            ...
            <footer class="footer">
                ...
                <p class="text-muted my-5 text-center">Made with ❤️ by the <a style="text-decoration: underline; color: #6c757d; font-weight: bold;"
                                                                              href="https://www.symfonycasts.com">SymfonyCasts</a> Team</p>
